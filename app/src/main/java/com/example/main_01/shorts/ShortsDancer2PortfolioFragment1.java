    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pf1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startPortfolioPlayViewActivity("https://moovitbucket2.s3.ap-northeast-2.amazonaws.com/dancer/tatter/tatter_pf1.mp4");
            }
        });
        ...
        pf2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startPortfolioPlayViewActivity("https://moovitbucket2.s3.ap-northeast-2.amazonaws.com/dancer/tatter/tatter_pf2.mp4");
            }
        });
