...
public class ShortsDancer1Profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shorts_dancer1_profile);
        ...
        arw.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(ShortsDancer1Profile.this, shorts1.class);
                startActivity(i);
                finish();
            }
        });
    ...
    static class PageAdapter extends FragmentStatePagerAdapter { //뷰 페이저 어뎁터
        ...
        public Fragment getItem(int position) {
            if (position == 0) { //프래그먼트 사용 포지션 설정 0 이 첫탭
                return new ShortsDancer1PortfolioFragment1();
            } else {
                return new ShortsDancer1PortfolioFragment2();
            }
