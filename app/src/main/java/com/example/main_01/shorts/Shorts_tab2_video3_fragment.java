...
public class Shorts_tab2_video3_fragment extends Fragment implements TextureView.SurfaceTextureListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_shorts_tab2_video3, container, false);
        ...
        String videoURL = "https://moovitbucket2.s3.ap-northeast-2.amazonaws.com/dancer/kinky/kinky_class2.mp4";
