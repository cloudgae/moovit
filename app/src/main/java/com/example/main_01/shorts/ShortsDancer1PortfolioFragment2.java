...
public class ShortsDancer1PortfolioFragment2 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_shorts_dancer1_portfolio2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        class1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startPortfolioPlayViewActivity(dancerName, R.drawable.dancer1_image_1, "https://moovitbucket2.s3.ap-northeast-2.amazonaws.com/dancer/lusher/lusher_class1.mp4");
            }
        });
        ...
        class2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String dancerName = "러셔\nLUSHER"; // 변경 예시 데이터, 실제 데이터로 변경
                startPortfolioPlayViewActivity(dancerName, R.drawable.dancer1_image_1, "https://moovitbucket2.s3.ap-northeast-2.amazonaws.com/dancer/lusher/lusher_class2.mp4");
            }
        });
