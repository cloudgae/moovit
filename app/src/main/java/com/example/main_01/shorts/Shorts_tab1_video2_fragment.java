...
public class Shorts_tab1_video2_fragment extends Fragment implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        try {
            ...
            mediaPlayer.setDataSource("https://moovitbucket2.s3.ap-northeast-2.amazonaws.com/UIS2.mp4");
