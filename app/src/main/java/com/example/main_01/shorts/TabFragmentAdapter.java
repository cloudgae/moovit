...
public class TabFragmentAdapter extends FragmentStateAdapter {
    ...
    public Fragment createFragment(int position) {
        ...
        switch (position) {
            case 0:
                return new Shorts_tab1_video1_fragment(); // 첫 번째 영상 프래그먼트
            case 1:
                return new Shorts_tab1_video2_fragment(); // 두 번째 영상 프래그먼트
            case 2:
                return new Shorts_tab1_video3_fragment(); // 세 번째 영상 프래그먼트
            default:
                return new Shorts_tab1_video1_fragment(); // 기본 프래그먼트
        }
    }
